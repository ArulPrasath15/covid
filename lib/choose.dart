...
class _ChooseState extends State<Choose> {
  List<Fetch> location = [
    ...
    Fetch(loc: 'Dindigul'),
    Fetch(loc: 'Erode'),
    Fetch(loc: 'Kallakurichi'),
    Fetch(loc: 'Kancheepuram'),
    Fetch(loc: 'Kanyakumari'),
    Fetch(loc: 'Karur'),
    Fetch(loc: 'Krishnagiri'),
    Fetch(loc: 'Madurai'),
    ...
    Fetch(loc: 'Thoothukkudi'),
    Fetch(loc: 'Tiruchirappalli'),
    Fetch(loc: 'Tirunelveli'),
    Fetch(loc: 'Tirupathur'),
    Fetch(loc: 'Tiruppur'),
    Fetch(loc: 'Tiruvannamalai'),
    Fetch(loc: 'Vellore'),
    Fetch(loc: 'Viluppuram'),
    Fetch(loc: 'Virudhunagar'),
  ];
